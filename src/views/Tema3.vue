...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-stretch.z-2.custom-cards.mt-5
      ...
      .col-md-6.col-lg-4.col-xl-3.mb-5.mb-sm-0.mb-md-0.mb-lg-5
      ...
      .col-md-6.col-lg-4.col-xl-3.mb-sm-5.mb-md-0.mb-xl-5
    ...
    .row.align-items-center.justify-content-center.z-2.mb-4.mb-lg-5
      ...
      .col-8.col-lg-4
        figure
          img(src="@/assets/curso/temas/tema3/6.png" alt="Imagen de una biela de motor")
    ...
    .row.justify-content-center.align-items-center
      .col-xl-8.p-4.p-lg-5.ps-lg-4.bg-img--1
        .row.justify-content-center.align-items-center
          .col-4.col-md-2.p-0
            figure
              img(src='@/assets/curso/temas/tema3/8.svg', alt='Ilustracion decorativa')
          .col-md-10
    ...
    .row.justify-content-center.align-items-center.z-2.mb-4.mb-lg-5
      ...
      .col-6.col-md-4.col-lg-2
        figure
        img(src='@/assets/curso/temas/tema3/9.svg', alt='Ilustración motor')
      ...
      .col-xl-10.p-4.bg-img--2
        .row.justify-content-center.align-items-center
          .col-6.d-md-none.d-lg-block.col-lg-2.p-4
            figure
              img(src='@/assets/curso/temas/tema3/12.svg', alt='Cojinete de la biela')
          .col-lg-10
